...
<head>
  ...
  <title>COGS Management System</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Dimas Adhitya</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- DATABASE CUSTOMER -->
          <li class="nav-item">
            <a href="<?= base_url("../module/database_cst/database_cst.php")?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-database"></i>
                <p>Funnel<i class="right fas fa-angle-left"></i></p>
            </a>
